...
export class ConfigService {
    ...
    public async getMongoConfig() {
        return {
            ...
            uri: 'mongodb://freeman:abcd1234@202.44.231.125:27014/weather-station?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&directConnection=true&ssl=false',
